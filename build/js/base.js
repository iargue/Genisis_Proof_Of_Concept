...
function createStage() {
	...
	leftSwap.textObject = new createjs.Text('Show Spells', textSize + "px " + textFont, 'black');
	...
	rightSwap.textObject = new createjs.Text('Show Inventory', textSize + "px " + textFont, 'black');
